...
public class BiuNetJSONResult {
    ...
    public static BiuNetJSONResult build(Integer status, String msg, Object data, String ok) {
        return new BiuNetJSONResult(status, msg, data, ok);
    }
    ...
    public BiuNetJSONResult(Integer status, String msg, Object data, String ok) {
        this.status = status;
        this.msg = msg;
        this.data = data;
        this.ok = ok;
