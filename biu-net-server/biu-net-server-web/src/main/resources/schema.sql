...
(
    id              VARCHAR(128) NOT NULL COMMENT '代理Id',
    client_id       VARCHAR(128) NOT NULL COMMENT '客户端Id',
    proxy_server_id VARCHAR(128) NOT NULL COMMENT '代理服务端id',
    target_host     VARCHAR(128) NOT NULL DEFAULT 'localhost' COMMENT '目标主机',
    target_port     integer      NOT NULL COMMENT ' 目标端口',
